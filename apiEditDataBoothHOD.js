$(document).ready(function () {
    ...
    fetch(domain + "api/boothgames/getById/" + idBoothGame, {
      ...
      .then((data) => {
        if (!data.error) {
          ...
          $("#guard1Name").empty();
          $("#guard1Name").append(
            new Option(booth.panitia1.namaPanitia, booth.panitia1.namaPanitia)
          );
            panitiaData[booth.panitia1.namaPanitia] = booth.panitia1.IDPanitia;

          $("#guard2Name").empty();
          if (booth.panitia2) {
            $("#guard2Name").append(new Option("Tidak Ada", "Tidak Ada"));
            var opsi = new Option(
              booth.panitia2.namaPanitia,
              booth.panitia2.namaPanitia
            );
            panitiaData[booth.panitia2.namaPanitia] = booth.panitia2.IDPanitia;
          ...
          $("#noRuangan").empty();
          $("#noRuangan").append(
            new Option(booth.lokasi.noRuangan, booth.lokasi.noRuangan)
          );
          ...
          var durasiMenit = booth.durasiPermainan.menit.toString();
          var durasiDetik = booth.durasiPermainan.detik.toString();
  ...
  async function postDataBooth() {
    ...
    let guard2Id = null;
    if(guard2Name != "Tidak Ada"){
      guard2Id = panitiaData[guard2Name];
    }
